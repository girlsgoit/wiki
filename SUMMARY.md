...
* [index](data-science/pandas.md)
* [Modele](data-science/modele.md)

## ROBOTICĂ

* [1.1 mBlock](robotica/mblock.md)
* [1.2 Descărcarea, instalarea și conectarea](robotica/downloading-installing-and-connecting.md)
...
* [2.3 Exerciții avansate - Scratch](robotica/exercitii-avansate.md)
* [3.0.1 Instalare Arduino IDE](robotica/3.0-instalare-arduino-ide.md)
* [3.0.2 Instalare Arduino IDE WEB](robotica/3.1-instalare-arduino-ide-web.md)
* [3.1 Configurare Arduino IDE](robotica/3.1-configurare-ide.md)
* [3.2 Introducere în limbajul C](robotica/3.1-introducere-in-limbajul-c.md)
* [3.3 Exemple Arduino - mBot](robotica/3.2-exemple-arduino.md)
* [3.4 Line follow - Arduino](robotica/line-follow-arduino.md)
* [3.5 Ultimate robot](robotica/3.5-exemple-arduino-ultimate.md)
