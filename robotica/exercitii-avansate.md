...
4. Scrieți un program  care are 2 roboți ce urmează linie. Primul robot are un senzor ultrasonic care se oprește dacă simte un obstacol și îi spune și celui de-al doilea robot să se oprească.
